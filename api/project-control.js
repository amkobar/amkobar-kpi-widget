...
<div id="t1-wrap" style="border:1px solid #2a2a2a;border-radius:8px;margin-bottom:10px"><div onclick="toggleT1()" style="display:flex;align-items:center;justify-content:space-between;padding:10px 14px;cursor:pointer;background:#252525;border-radius:8px;border:1px solid #378ADD" id="t1-hdr"><div style="display:flex;align-items:center;gap:8px"><div style="width:6px;height:6px;border-radius:50%;background:#378ADD"></div><span style="font-size:11px;font-weight:700;color:#888;text-transform:uppercase;letter-spacing:.05em">Tahap 1 - Sebelum Registrasi</span><span style="font-size:10px;color:#555" id="t1-hint">(klik untuk buka)</span></div><div style="width:18px;height:18px;border-radius:4px;background:#333;display:flex;align-items:center;justify-content:center"><svg width="10" height="10" viewBox="0 0 10 10" fill="none"><polyline id="t1-arrow" points="2,3.5 5,6.5 8,3.5" stroke="#888" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div></div><div id="t1-body" style="display:none;padding:14px;border-top:1px solid #2a2a2a"><div style="display:grid;grid-template-columns:1.1fr 1fr;gap:14px"><div><div class="lbl">Langkah Konfirmasi</div><div style="display:flex;gap:8px;margin-bottom:7px"><div style="width:17px;height:17px;border-radius:50%;background:#1a3a5c;color:#378ADD;font-size:10px;font-weight:700;display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:1px">1</div><div style="font-size:12px;color:#aaa;line-height:1.45">Verifikasi DP sudah masuk dari bukti transfer client</div></div><div style="display:flex;gap:8px;margin-bottom:7px"><div style="width:17px;height:17px;border-radius:50%;background:#1a3a5c;color:#378ADD;font-size:10px;font-weight:700;display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:1px">2</div><div style="font-size:12px;color:#aaa;line-height:1.45">Generate pesan WA di kanan ketik nama dan lihat di database bawah, copy dan kirim ke client</div></div><div style="display:flex;gap:8px;margin-bottom:7px"><div style="width:17px;height:17px;border-radius:50%;background:#1a3a5c;color:#378ADD;font-size:10px;font-weight:700;display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:1px">3</div><div style="font-size:12px;color:#aaa;line-height:1.45">Tentukan dahulu Klien termasuk kerjasama atau Umum</div></div><div style="display:flex;gap:8px"><div style="width:17px;height:17px;border-radius:50%;background:#1a3a5c;color:#378ADD;font-size:10px;font-weight:700;display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:1px">4</div><div style="font-size:12px;color:#aaa;line-height:1.45">Tunggu client isi form - data muncul otomatis di tab Menunggu Review</div></div></div><div style="border-left:1px solid #2a2a2a;padding-left:14px"><div class="lbl">Generator Pesan - Sebelum Registrasi</div><div class="row"><input id="inp-nama" class="inp" placeholder="Ketik nama client..." oninput="gR()"><select id="inp-kat" class="inp" onchange="gR()" style="width:110px"><option value="kerjasama">Kerjasama</option><option value="umum">Umum</option></select></div><div id="prev-review" class="prev" style="height:160px">Ketik nama client untuk generate pesan...</div><button class="btn" id="btn-review" onclick="cp('review')">&#128203; Copy Pesan</button></div></div></div></div>

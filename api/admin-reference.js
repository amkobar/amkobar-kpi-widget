module.exports = async function handler(req, res) {
  var html = `<!DOCTYPE html><html><head><meta charset="utf-8"><style>*{box-sizing:border-box;margin:0;padding:0}html,body{background:#191919;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:#d3d3d3}body{padding:20px}.grid{display:grid;grid-template-columns:1fr 1fr;gap:12px}.card{background:#1c1c1c;border:1px solid #2c2c2c;border-radius:10px;overflow:hidden}.card-hdr{padding:12px 16px;border-bottom:1px solid #262626;display:flex;align-items:center;gap:8px}.card-dot{width:7px;height:7px;border-radius:50%;flex-shrink:0}.card-ttl{font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:#777}.row{display:flex;align-items:center;gap:12px;padding:13px 16px;border-bottom:1px solid #222}.row:last-child{border-bottom:none}.ri{flex:1;min-width:0}.badge{display:inline-flex;padding:3px 10px;border-radius:100px;font-size:12px;font-weight:600;margin-bottom:5px}.bk{background:#0C447C;color:#85B7EB}.bu{background:#633806;color:#FAC775}.val{font-size:15px;color:#e8e8e8;font-family:monospace;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.lbl{font-size:12px;color:#666;margin-bottom:4px}.btn{padding:7px 16px;background:#262626;border:1px solid #3a3a3a;border-radius:6px;font-size:13px;font-weight:600;cursor:pointer;color:#aaa;flex-shrink:0;transition:.15s;min-width:70px;text-align:center}.btn:hover{background:#303030;color:#ddd;border-color:#555}.btn.ok{background:#0a2e15;border-color:#1a5c2a;color:#4ade80}::-webkit-scrollbar{width:4px}::-webkit-scrollbar-thumb{background:#333;border-radius:10px}</style></head><body>
<div class="grid">

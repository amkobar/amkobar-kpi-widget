module.exports = async function handler(req, res) {
  var html = `<!DOCTYPE html><html><head><meta charset="utf-8"><style>*{box-sizing:border-box;margin:0;padding:0}html,body{background:#191919;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:#d3d3d3}body{padding:18px}.grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}.card{background:#1c1c1c;border:1px solid #2c2c2c;border-radius:10px;overflow:hidden}.card-hdr{padding:10px 14px;border-bottom:1px solid #262626;display:flex;align-items:center;gap:7px}.card-dot{width:6px;height:6px;border-radius:50%;flex-shrink:0}.card-ttl{font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:#666}.row{display:flex;align-items:center;gap:10px;padding:10px 14px;border-bottom:1px solid #222}.row:last-child{border-bottom:none}.ri{flex:1;min-width:0}.badge{display:inline-flex;padding:2px 8px;border-radius:100px;font-size:10px;font-weight:600;margin-bottom:4px}.bk{background:#0C447C;color:#85B7EB}.bu{background:#633806;color:#FAC775}.val{font-size:13px;color:#e0e0e0;font-family:monospace;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.lbl{font-size:11px;color:#555;margin-bottom:3px}.btn{padding:5px 12px;background:#262626;border:1px solid #3a3a3a;border-radius:5px;font-size:11px;font-weight:600;cursor:pointer;color:#999;flex-shrink:0;transition:.15s;min-width:58px;text-align:center}.btn:hover{background:#303030;color:#ddd;border-color:#555}.btn.ok{background:#0a2e15;border-color:#1a5c2a;color:#4ade80}::-webkit-scrollbar{width:4px}::-webkit-scrollbar-thumb{background:#333;border-radius:10px}</style></head><body>
<div class="grid">
